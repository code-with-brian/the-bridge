defmodule TheBridge.Accounts do
  @moduledoc """
  ...
  alias TheBridge.Accounts.{User, UserToken, UserNotifier}
  ...
  def list_users_by_role(role) do
    User |> where(role: ^role) |> order_by(:email) |> Repo.all()
  end
  ...
  def register_user(attrs) do
    ...
    |> Ecto.Changeset.validate_length(:display_name, min: 2, max: 50)
    |> Repo.insert()
  end
